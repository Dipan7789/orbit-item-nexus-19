      ...
      <div className={`relative w-full max-w-md ${mounted ? 'animate-scale-in' : 'opacity-0'}`}>
        ...
        <div className="relative">
          ...
          <div className={`mt-8 text-center text-sm text-muted-foreground ${mounted ? 'animate-fade-in animate-delay-500' : 'opacity-0'}`}>
            <p>By signing up, you agree to our <a href="#" className="text-primary hover:text-primary/90 underline">Terms of Service</a> and <a href="#" className="text-primary hover:text-primary/90 underline">Privacy Policy</a></p>
          </div>
        </div>
      </div>
    </div>
